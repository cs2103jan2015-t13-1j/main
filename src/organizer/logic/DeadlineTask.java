...
public class DeadlineTask {
	...
	private static final String PATTERN_DEADLINE_ENDDATETIME = "(\\d)(\\s)(\\bby\\b)(\\s)(((19|20)\\d\\d)-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01]))(\\s)(([01]?[0-9]|2[0-3]):([0-5][0-9]))";
	private static final String PATTERN_DEADLINE_ENDDATE = "(\\d)(\\s)(\\bby\\b)(\\s)(((19|20)\\d\\d)-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01]))";
	private static final String PATTERN_DEADLINE_ENDDAY = "(\\d)(\\s)(\\bby\\b)(\\s)(monday|tuesday|wednesday|thursday|friday|saturday|sunday|mon|tues|wed|thurs|fri|sat|sun|today|tomorrow)";
	private static final String PATTERN_DEADLINE_ENDDAYTIME = "(\\d)(\\s)(\\bby\\b)(\\s)(monday|tuesday|wednesday|thursday|friday|saturday|sunday|mon|tues|wed|thurs|fri|sat|sun|today|tomorrow)(\\s)(([01]?[0-9]|2[0-3]):([0-5][0-9]))";
